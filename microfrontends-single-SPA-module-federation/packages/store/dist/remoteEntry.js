...
var moduleMap = {
	"./store": () => {
		return __webpack_require__.e("src_store_js").then(() => (() => ((__webpack_require__(/*! ./src/store */ "./src/store.js")))));
	}
};
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "http://localhost:3005/";
/******/ 	})();
/******/ 	
